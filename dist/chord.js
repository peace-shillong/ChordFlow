...
export function normalizeRoot(root) {
    ...
    if (ENHARMONIC_EQUIVALENTS[trimmed])
        return ENHARMONIC_EQUIVALENTS[trimmed];
    const upper = trimmed.toUpperCase();
    if (ENHARMONIC_EQUIVALENTS[upper])
        return ENHARMONIC_EQUIVALENTS[upper];
...
export class ChordDatabase {
     ...
     */
    generateProgressionForChord(chordId, styleId) {
