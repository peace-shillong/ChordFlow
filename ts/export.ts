import { AppState, Chord, InstrumentId, StrumPattern } from "./types.js";
import { DiagramRenderer } from "./diagrams.js";

export class ExportEngine {
  private diagramRenderer: DiagramRenderer = new DiagramRenderer();

  /**
   * Export progression and settings as JSON file
   */
  public exportJSON(state: AppState, title: string = "Progression"): void {
    const data = {
      appName: "ChordFlow",
      version: "1.0",
  ...
  public async exportPDF(
    ...
    chordObjects: Chord[],
    strumPatternObj?: StrumPattern,
    title: string = "Chord Progression Sheet"
  ): Promise<void> {
